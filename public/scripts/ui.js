...
Events.on('display-name', e => {
    ...
    $displayName.textContent = 'Você é conhecido como ' + me.displayName;
...
class PeerUI {
    ...
    html() {
        return `
            <label class="column center" title="Clique para enviar arquivos ou clique com o botão direito para enviar um texto">
